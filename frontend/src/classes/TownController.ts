...
import EscapeRoomAreaController from './interactable/EscapeRoomAreaController';
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      this._socket.on('initialize', initialData => {
        ...
        initialData.interactables.forEach(eachInteractable => {
          ...
          } else if (isEscapeRoomArea(eachInteractable)) {
            this._interactableControllers.push(
              new EscapeRoomAreaController(eachInteractable.id, eachInteractable, this),
            );
          }
        });
